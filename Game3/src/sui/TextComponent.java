...
import sui.event.KeyEvent;
import sui.event.KeyListener;
import sui.event.MouseAdapter;
import sui.event.MouseEvent;
import sui.event.MouseListener;
...
public abstract class TextComponent extends Container {
    ...
    protected class TextKeyListener extends KeyAdapter implements KeyListener {
